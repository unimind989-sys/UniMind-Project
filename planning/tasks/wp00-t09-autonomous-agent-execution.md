...
**Policy version:** 1 (initial implementation target)
...
**Model floor:** Sol High for WP00-T09; the current Codex runtime does not expose a safe in-place primary-model switch to repository tooling, so the policy must surface rather than fake unmet model floors
...
**Procedural skills:** writing-for-agents, skill-maintainer, codebase-design
