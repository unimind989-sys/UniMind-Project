...
- `decision-workshop.html` — a local bilingual form where Ahmed and Ziad answer the 11 unresolved decisions independently and export individual or combined review files; exports are discussion inputs, not approvals.
