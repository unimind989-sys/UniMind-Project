...
Deploying a locked Beta candidate is not Beta go-live. Unlock/release remains a protected gate; D-22 supplies standing Ahmed-and-Ziad authorization for selected-task non-financial delivery after technical proof.
...
- Named speaker/checkpoint; later Beta unlock/go-live evidence records D-22 standing authorization and identifies `$finalize` only when it was the manual/recovery entry.
